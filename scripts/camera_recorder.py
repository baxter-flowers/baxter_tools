...
class BaxterVideoRecorder():
    ...
    def __init__(self, width, height):
        ...
        # Tricky behaviour: 2 cameras are always kept opened with L/R opened by default
        # Closing a closed camera raises an unclear error, so let's work with default openings
